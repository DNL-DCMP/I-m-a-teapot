/*
  ...
  - Added the required column `temperatureCook` to the `Recipe` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "temperatureCook" INTEGER NOT NULL,
